...
export class EntryFormComponent implements OnInit, AfterContentChecked {
 ...
 private  buildEntryForm() {
  ...
  private createEntry() {
    ...
    this.entryService.create(entry).subscribe((entryResponse: Entry) => {
      this.actionsForSuccess(entryResponse);
    }, error => {
  ...
  private updateEntry() {
    const entry: Entry = Object.assign(new Entry(), this.entryForm.value);
    this.entryService.update(entry).subscribe((entryResponse: Entry) => {
      this.actionsForSuccess(entryResponse);
    }, error => {
      this.actionsForError(error);
    });
